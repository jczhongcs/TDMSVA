<template>
      ...
      <div class="left">
        <div class="left-top">
          <a-space direction="vertical" size="middle">
            ...
            <a-modal title="连接数据库" ok-text="确认" cancel-text="取消" v-model:visible="visible_loading_database"
              :confirm-loading="confirmLoading" @ok="get_package_list">
              <a-input addon-before="网络地址" style="padding-bottom: 20px" v-model:value="p_database_ip" />
          ...
          <div style="display: flex; align-items: center; padding: 10px;">
            <div style="margin-right: 20px;">
                pacakageName: 
                <a-input v-model:value="packageName" style="width: 200px" placeholder="Please input" />
            </div>

            <div style="margin-right: 20px;">
                proteinName:
                <a-input v-model:value="proteinName" style="width: 200px" placeholder="Please input" />
            </div>
                ...
                <template v-if="column.key === 'operation'">
                  <div>
                    <a-select
                      ...
                      placeholder=""
                      @change="handleColumnChange(record, index, $event)"
                    >
  ...
  const handleColumnChange = (record, index, value) => {
  ...
  function visualize(index) {
    disableResetLabel.value = false;
      ...
      option.xAxis[index].max = parseInt(max + 50);
      option.xAxis[index].min = parseInt(max - 1050);
